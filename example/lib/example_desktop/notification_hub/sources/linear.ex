defmodule ExampleDesktop.NotificationHub.Sources.Linear do
  @moduledoc """
  Fake Linear notification source.

  A real adapter would call Linear's GraphQL API (or listen to their
  webhook events) and translate issue/comment events into `Notification`
  structs.
  """
  ...
  @templates [
    ...
    {"mentioned", "You were mentioned in %{key}",
     "%{actor} mentioned you: %{snippet}", :high, []}
  ]

  @actors ["fel", "amy", "tom", "ivan", "clara"]
  @titles [
