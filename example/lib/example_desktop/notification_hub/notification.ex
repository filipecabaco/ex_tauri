defmodule ExampleDesktop.NotificationHub.Notification do
  @moduledoc """
  ...
  @type source :: :github | :linear | :gmail | :slack | :pomodoro
  ...
  @doc "Generates a short random identifier."
  def new_id do
    :crypto.strong_rand_bytes(8) |> Base.hex_encode32(padding: false, case: :lower)
  end

  @doc "Returns `true` if the notification is currently snoozed."
